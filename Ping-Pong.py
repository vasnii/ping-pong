...
back = transform.scale(image.load(fon), (win_widht, win_height))
...
racket1 = Player('prm.png', 30, 200, 4, 50, 150)
racket2 = Player('prm.png', 520, 200, 4, 50, 150)
